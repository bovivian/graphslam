#ifndef GRAPH_SLAM__GRAPH_SLAM_UTILS_HPP_
#define GRAPH_SLAM__GRAPH_SLAM_UTILS_HPP_
...
geometry_msgs::msg::Vector3 convert_quaternion_to_euler(const geometry_msgs::msg::Quaternion quaternion) {
...
geometry_msgs::msg::Pose convert_transform_to_pose(  const geometry_msgs::msg::TransformStamped transform_stamped) {
  geometry_msgs::msg::Pose pose;
...
Eigen::Matrix4f convert_transform_to_matrix(const geometry_msgs::msg::TransformStamped transform_stamped) {
...
std_msgs::msg::ColorRGBA create_color(const double a, const double r, const double g, const double b) {
